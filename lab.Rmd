...
Sys.setenv("tiktok_vpn_host" = "198.91.147.92", "tiktok_vpn_port" = "60003")
...
a <- tk_comment(post_id = "6826825525630078213", verify = verify, id_cookie = id_cookie, vpn = F, verbose = T)
a 
