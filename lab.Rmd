...
source_python("https://raw.githubusercontent.com/davidteather/TikTok-Api/master/TikTokApi/stealth.py")
source_python("browser_3.py")
...
reticulate::source_python("https://raw.githubusercontent.com/davidteather/TikTok-Api/master/TikTokApi/stealth.py")
reticulate::source_python("stealth.py")
reticulate::source_python("browser_3.py")
...
+ What are the Huber countries exactly? 


+ How much of the results migth be driven by CMP measurement's error? 

+ Manifesto getting longer and less precise about actual position of parties


+ Convergence of mainstream parties => less polarisation => less reponsiveness
