...
In November 2020, Tiktok increased its security issue. They now have a captcha, which easily triggered after a few request. This can be solved by specifying the cookie parameter. To get a cookie session: 
